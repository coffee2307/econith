...
export const en: Dictionary = {
  ...
  world: {
    ...
    queued: "queued",
    waitingEvents: "waiting for regime / hypothesis / macro events…",
    ...
    agentExchangeSubtitle:
      "Corporate / Government / Societal AI + hypotheses — not the market-regime ticker",
    agentExchangeRefresh: "Refresh debate",
    agentExchangeLoading: "Synthesizing agent positions…",
    agentExchangeEmpty:
      "No agent lines yet. Tweak sliders, wait for autonomous hypotheses, or arm Autonomous Hypothesis mode.",
    agentExchangeLive: "Live sim",
    agentExchangeWaiting: "Waiting",
    eventsPanelHint:
      "Events = market regime, Quant→Macro, hypothesis ops log",
    agentsPanelHint:
      "Agents = Corporate / Government / Societal AI + scenario proposals",
    backendStatus: "Kernel",
    backendLive: "LIVE mutate",
    backendTopologyOnly: "topology only",
    backendTopologyHint:
      "Globe topology outside 10 hubs — backend simulates USA/CHN/VNM/JPN/IND/DEU/GBR/FRA/BRA/SAU.",
  },
  macro: {
