...
export const vi: Dictionary = {
  ...
  world: {
    ...
    queued: "đang chờ",
    waitingEvents: "đang chờ sự kiện chế độ / giả thuyết / macro…",
    ...
    agentExchangeSubtitle:
      "AI doanh nghiệp / chính phủ / xã hội + giả thuyết — không lẫn ticker chế độ thị trường",
    agentExchangeRefresh: "Làm mới tranh luận",
    agentExchangeLoading: "Đang tổng hợp quan điểm tác tử…",
    agentExchangeEmpty:
      "Chưa có phát biểu tác tử. Kéo slider / đợi giả thuyết tự động, hoặc bật mode Giả thuyết tự động.",
    agentExchangeLive: "Sim trực tiếp",
    agentExchangeWaiting: "Đang chờ",
    eventsPanelHint:
      "Sự kiện = chế độ thị trường, Quant→Macro, nhật ký giả thuyết",
    agentsPanelHint:
      "Tác tử = AI doanh nghiệp / chính phủ / xã hội + đề xuất kịch bản",
    backendStatus: "Kernel",
    backendLive: "LIVE — chỉnh được",
    backendTopologyOnly: "chỉ topology",
    backendTopologyHint:
      "Chỉ topology globe ngoài 10 hub — backend mô phỏng USA/CHN/VNM/JPN/IND/DEU/GBR/FRA/BRA/SAU.",
  },
  macro: {
