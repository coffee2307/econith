...
def default_world() -> WorldState:
    ...
    countries = {
        ...
        "GBR": _country(
            ...
            gdp=3.3e12, growth=0.012, per_capita=48_000, population=68_000_000,
            monetary={"interest_rate": 0.050, "inflation_cpi": 0.030, "fx_spot": 0.79},
            fiscal={"corporate_tax": 0.25, "govt_debt_to_gdp": 0.98, "trade_balance_pct": -0.02},
            industrial={"manufacturing_pmi": 48.5, "semiconductor_capacity": 0.02},
            geopolitical={"defense_spending_pct": 0.022, "military_strength_index": 0.72,
                          "political_stability": 0.70, "nuclear_capability": 1.0},
        ),
        "FRA": _country(
            "FRA", "France", "Europe",
            gdp=3.0e12, growth=0.010, per_capita=44_000, population=68_000_000,
            monetary={"interest_rate": 0.040, "inflation_cpi": 0.028, "fx_spot": 0.92},
            fiscal={"corporate_tax": 0.25, "govt_debt_to_gdp": 1.10, "trade_balance_pct": -0.01},
            industrial={"manufacturing_pmi": 46.5, "renewable_share": 0.25},
            geopolitical={"defense_spending_pct": 0.019, "military_strength_index": 0.70,
                          "political_stability": 0.72, "nuclear_capability": 1.0},
        ),
        "BRA": _country(
            "BRA", "Brazil", "South America",
            gdp=2.2e12, growth=0.022, per_capita=10_000, population=216_000_000,
            monetary={"interest_rate": 0.105, "inflation_cpi": 0.045, "fx_spot": 5.1},
            fiscal={"corporate_tax": 0.34, "govt_debt_to_gdp": 0.88, "trade_balance_pct": 0.01},
            industrial={"manufacturing_pmi": 52.0, "oil_reserves": 1.5e10, "energy_independence": 1.1},
            labor={"workforce_participation": 0.62, "unemployment": 0.078},
            geopolitical={"defense_spending_pct": 0.013, "political_stability": 0.55},
        ),
        "SAU": _country(
            "SAU", "Saudi Arabia", "Middle East",
            gdp=1.1e12, growth=0.027, per_capita=30_000, population=37_000_000,
            monetary={"interest_rate": 0.055, "inflation_cpi": 0.022, "fx_spot": 3.75},
            fiscal={"corporate_tax": 0.20, "govt_debt_to_gdp": 0.30, "trade_balance_pct": 0.08},
            industrial={"oil_reserves": 2.6e11, "manufacturing_pmi": 55.0, "energy_independence": 2.5},
            geopolitical={"defense_spending_pct": 0.070, "military_strength_index": 0.55,
    ...
    base_trust = {
        ...
        ("USA", "VNM"): 0.6, ("USA", "CHN"): 0.35, ("USA", "GBR"): 0.92,
        ("USA", "FRA"): 0.82, ("USA", "BRA"): 0.65, ("USA", "SAU"): 0.70,
        ("CHN", "VNM"): 0.55, ("CHN", "IND"): 0.4, ("CHN", "JPN"): 0.45,
        ("CHN", "DEU"): 0.55, ("CHN", "BRA"): 0.60, ("CHN", "SAU"): 0.55,
        ("JPN", "DEU"): 0.8, ("JPN", "IND"): 0.7, ("JPN", "GBR"): 0.75,
        ("DEU", "IND"): 0.7, ("DEU", "FRA"): 0.90, ("DEU", "GBR"): 0.80,
        ("FRA", "GBR"): 0.78, ("FRA", "SAU"): 0.55,
        ("VNM", "JPN"): 0.7, ("VNM", "IND"): 0.65, ("VNM", "DEU"): 0.6,
        ("IND", "DEU"): 0.7, ("IND", "GBR"): 0.68, ("BRA", "DEU"): 0.60,
        ("SAU", "GBR"): 0.62, ("SAU", "IND"): 0.55,
    }
