# ECONITH Quant basics

This page provides you some basic concepts on how ECONITH Quant works and operates.

## ECONITH Quant terminology
...
All profit calculations of ECONITH Quant include fees. For Backtesting / Hyperopt / Dry-run modes, the exchange default fee is used (lowest tier on the exchange). For live operations, fees are used as applied by the exchange (this includes BNB rebates etc.).

## Pair naming

ECONITH Quant follows the [ccxt naming convention](https://docs.ccxt.com/#/README?id=consistency-of-base-and-quote-currencies) for currencies.
...
Starting econith in dry-run or live mode (using `econith trade`) will start the bot and start the bot iteration loop.
