...
Choose the public name of your bot (e.x. `ECONITH Quant bot`)
...
For the ECONITH Quant configuration, you can then use the full value (including `-` ) as string:
...
ECONITH Quant provides means to control the verbosity of your telegram bot.
