class ECONITH QuantException(Exception):
    """
    ECONITH Quant base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(ECONITH QuantException):
    """
...
class DependencyException(ECONITH QuantException):
    """
...
class StrategyError(ECONITH QuantException):
    """
