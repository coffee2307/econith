...
from econith.configuration.load_config import CONFIG_PARSE_MODE
from econith.exceptions import OperationalException
from econith.exchange.exchange_types import Tickers
from econith.plugins.pairlist.IPairList import IPairList, PairlistParameter, SupportsBacktesting
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> tuple[list[str], float]:
        headers = {"User-Agent": "ECONITH Quant/" + __version__ + " Remotepairlist"}
