...
from econith.enums.runmode import NON_UTIL_MODES
...
from econith.exchange.exchange_types import CcxtBalances, CcxtOrder, CcxtPosition, FtHas
from econith.util.datetime_helpers import dt_from_ts
...
class Hyperliquid(Exchange):
    ...
    def get_balances(self, params: dict | None = None) -> CcxtBalances:
        ...
        which are however not used by ECONITH Quant in futures mode at the moment.
        """
        params = params or {}
        if self.unified_account:
            params["type"] = "spot"
