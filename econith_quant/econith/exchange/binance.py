...
from econith.enums import TRADE_MODES, CandleType, MarginMode, PriceType, RunMode, TradingMode
from econith.exceptions import DDosProtection, OperationalException, TemporaryError
from econith.exchange import Exchange
from econith.exchange.binance_public_data import (
    concat_safe,
    download_archive_ohlcv,
    download_archive_trades,
)
from econith.exchange.common import retrier
from econith.exchange.exchange_types import FtHas, Tickers
from econith.exchange.exchange_utils_timeframe import timeframe_to_msecs
from econith.misc import deep_merge_dicts, json_load
from econith.util import FtTTLCache
from econith.util.datetime_helpers import dt_from_ts, dt_ts
...
class Binance(Exchange):
    ...
    Contains adjustments needed for ECONITH Quant to work with this exchange.
    """
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by econith. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by econith. "
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/econith/econith/pull/5779#discussion_r740175931
