...
from econith.enums import OPTIMIZE_MODES, CandleType, MarginMode, PriceType, TradingMode
...
from econith.exchange.common import API_RETRY_COUNT, retrier
from econith.exchange.exchange_types import CcxtOrder, FtHas
from econith.util import dt_from_ts, dt_now, dt_ts
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES and self.margin_mode == MarginMode.ISOLATED:
            ...
            raise OperationalException(
                "ECONITH Quant currently only supports isolated futures for bitget"
            )
