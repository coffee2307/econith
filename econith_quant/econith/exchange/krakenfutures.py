...
from econith.enums import MarginMode, PriceType, TradingMode
...
from econith.exchange.common import API_FETCH_ORDER_RETRY_COUNT, retrier
from econith.exchange.exchange import Exchange
from econith.exchange.exchange_types import CcxtBalances, CcxtOrder, FtHas
from econith.misc import safe_value_nested
...
class Krakenfutures(Exchange):
    ...
    def get_trades_for_order(
        ...
        using the market's fee schedule so ECONITH Quant's fee detection works.
        """
