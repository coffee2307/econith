...
from econith.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from econith.data.converter import populate_dataframe_with_trades
from econith.data.converter.converter import reduce_dataframe_footprint
...
from econith.exceptions import OperationalException, StrategyError
from econith.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from econith.ft_types import AnnotationType
from econith.misc import remove_entry_exit_signals
from econith.persistence import Order, PairLocks, Trade
from econith.strategy.hyper import HyperStrategyMixin
from econith.strategy.informative_decorator import (
    InformativeData,
    PopulateIndicators,
    _create_and_merge_informative_pair,
    _format_pair_name,
)
from econith.strategy.strategy_validation import StrategyResultValidator
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for econith strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from econith.freqai.utils import download_all_data_for_training
    ...
    def confirm_trade_entry(
        ...
        **kwargs,
        ...
        For full documentation please go to https://econith/en/stable/strategy-advanced/
    ...
    def adjust_entry_price(
        ...
        **kwargs,
        ...
        For full documentation please go to https://econith/en/stable/strategy-callbacks/
    ...
    def feature_engineering_expand_all(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://econith/en/stable/freqai-parameter-table/#feature-parameters

        https://econith/en/stable/freqai-feature-engineering/#defining-the-features
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by econith itself, but intended to be used if users lock pairs
    ...
    def ft_plot_annotations(self, pair: str, dataframe: DataFrame) -> list[AnnotationType]:
        ...
        if len(dataframe) > 0:
            ...
            from econith.ft_types.plot_annotation_type import AnnotationTypeTA
