...
from econith.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for econith hyperopt
    ...
    def roi_space(self) -> list[Dimension]:
        ...
        It's used by ECONITH Quant by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy ECONITH Quant roi_space()
