...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from econith.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting econith in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from econith.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting econith in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of econith Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help econith to exit
