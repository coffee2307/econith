...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from econith.exchange import list_available_exchanges
    from econith.ft_types import ValidExchangesType
    from econith.loggers.rich_console import get_rich_console
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for ECONITH Quant ({len(available_exchanges)} exchanges):"
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from econith.configuration import setup_utils_configuration
    from econith.exchange import market_is_active
    from econith.misc import plural, safe_value_fallback
    from econith.resolvers import ExchangeResolver
    from econith.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from econith.configuration import setup_utils_configuration
    from econith.misc import parse_db_uri_for_logging
    from econith.persistence import Trade, init_db
