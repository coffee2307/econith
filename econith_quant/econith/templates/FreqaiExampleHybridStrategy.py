...
from econith.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    FreqAI to bolster a typical ECONITH Quant strategy.

    Launching this strategy would be:

    econith trade --strategy FreqaiExampleHybridStrategy --strategy-path econith/templates
