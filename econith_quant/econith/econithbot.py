"""
ECONITH Quant is the main module of this bot. It contains the EconithBot class.
"""
...
from econith.configuration import remove_exchange_credentials, validate_config_consistency
from econith.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from econith.data.converter import order_book_to_dataframe
...
from econith.exchange.exchange_types import CcxtOrder
from econith.leverage.liquidation_price import update_liquidation_prices
from econith.misc import safe_value_fallback, safe_value_fallback2
from econith.mixins import LoggingMixin
from econith.persistence import Order, PairLocks, Trade, init_db
from econith.persistence.key_value_store import set_startup_time
from econith.plugins.pairlistmanager import PairListManager
from econith.plugins.protectionmanager import ProtectionManager
from econith.resolvers import ExchangeResolver, StrategyResolver
from econith.rpc import RPCManager
from econith.rpc.external_message_consumer import ExternalMessageConsumer
from econith.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from econith.strategy.strategy_wrapper import strategy_safe_wrapper
from econith.util import FtPrecise, MeasureTime, PeriodicCache, dt_from_ts, dt_now
from econith.util.migrations import migrate_live_content
from econith.wallets import Wallets


logger = logging.getLogger(__name__)


class EconithBot(LoggingMixin):
    """
    ECONITH Quant is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        try:
            ...
            # initialization, even before ECONITH Quantbot has a chance to start its throttling,
            # so anything in the ECONITH Quantbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, econith may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade) -> bool:
        ...
        try:
            ...
            # catching https://github.com/econith/econith/issues/9025
