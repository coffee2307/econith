    ...
    "properties": {
        ...
        "telegram": {
            ...
            "properties": {
                ...
                "chat_id": {
                    "description": (
                        f"Telegram chat or group ID. {__VIA_ENV} ECONITH_QUANT__TELEGRAM__CHAT_ID"
                    ),
                    "type": "string",
                },
                "topic_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__TELEGRAM__TOPIC_ID"
                    ),
                    "type": "string",
                },
                "authorized_users": {
        ...
        "webhook": {
            ...
            "properties": {
                ...
                "url": {
                    "description": f"Webhook URL. {__VIA_ENV} ECONITH_QUANT__WEBHOOK__URL",
                    "type": "string",
                },
        ...
        "discord": {
            ...
            "properties": {
                ...
                "webhook_url": {
                    "description": (
                        f"Discord webhook URL. {__VIA_ENV} ECONITH_QUANT__DISCORD__WEBHOOK_URL"
                    ),
                    "type": "string",
                },
                "exit_fill": {
    ...
    "definitions": {
        "exchange": {
            ...
            "properties": {
                ...
                "key": {
                    "description": (
                        f"API key for the exchange. {__VIA_ENV} ECONITH_QUANT__EXCHANGE__KEY"
                    ),
                    "type": "string",
                    "default": "",
                },
                "secret": {
                    "description": (
                        f"API secret for the exchange. {__VIA_ENV} ECONITH_QUANT__EXCHANGE__SECRET"
                    ),
                    "type": "string",
                    "default": "",
                },
                "password": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__EXCHANGE__PASSWORD"
                    ),
                    "type": "string",
                    "default": "",
                },
                "uid": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__EXCHANGE__UID"
                    ),
                    "type": "string",
                },
                "account_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__EXCHANGE__ACCOUNT_ID"
                    ),
                    "type": "string",
                },
                "wallet_address": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__EXCHANGE__WALLET_ADDRESS"
                    ),
                    "type": "string",
                },
                "private_key": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ECONITH_QUANT__EXCHANGE__PRIVATE_KEY"
                    ),
                    "type": "string",
                },
                "pair_whitelist": {
