...
from econith.enums import NO_ECHO_MESSAGES, RPCMessageType
from econith.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, econith) -> None:
        ...
        self._rpc = RPC(econith)
        config = econith.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from econith.rpc.telegram import Telegram
