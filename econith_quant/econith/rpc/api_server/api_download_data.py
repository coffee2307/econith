...
from econith.persistence import FtNoDBContext
from econith.rpc.api_server.api_pairlists import handleExchangePayload
from econith.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
from econith.rpc.api_server.deps import get_config, get_exchange
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from econith.data.history.history_utils import download_data
