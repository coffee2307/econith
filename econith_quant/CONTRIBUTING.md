...
1. Past contributions to ECONITH Quant and other related open source projects. Contributions to ECONITH Quant include both code (both accepted and pending) and friendly participation in the issue tracker and Pull request reviews. Both quantity and quality are considered.
1. A coding style that the other core committers find simple, minimal, and clean.
1. Access to resources for cross-platform development and testing.
1. Time to devote to the project regularly.

Being a Committer does not automatically grant write permission on `develop` or `stable` for security reasons (Users trust ECONITH Quant with their Exchange API keys).
